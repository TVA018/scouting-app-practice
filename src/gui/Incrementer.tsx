...
const Incrementer = ({text, value, onChange}: IncrementerProps) => {
    ...
    const parentDivTCSS = `flex flex-col justify-center items-center w-25`;
    const childDivTCss = `flex flex-row w-25 items-center`;
    const buttonHTMLClass = "w-8 h-8 bg-blue-950 rounded-4xl text-sm hover:bg-blue-800";
    ...
    return (
        <div className={parentDivTCSS}>
            ...
            <div className={childDivTCss}>
                ...
                <h1 className="w-10 text-center text-base">{value}</h1>
